...
) ENGINE=MyISAM AUTO_INCREMENT=184 DEFAULT CHARSET=utf8mb4 COMMENT='后台菜单表';
...
INSERT INTO `cmf_admin_menu` VALUES ('178', '0', '1', '1', '10000', 'grab', 'AdminNow', 'index', '', '实时统计', 'university', '');
INSERT INTO `cmf_admin_menu` VALUES ('179', '178', '1', '1', '10000', 'grab', 'AdminNow', 'indexlist', '', '访问统计', '', '');
INSERT INTO `cmf_admin_menu` VALUES ('181', '0', '1', '1', '10000', 'weixin', 'AdminWeixin', 'index', '', '微信管理', '', '');
INSERT INTO `cmf_admin_menu` VALUES ('182', '181', '1', '1', '10000', 'weixin', 'AdminWei', 'index', '', '微信操作', '', '');
INSERT INTO `cmf_admin_menu` VALUES ('183', '0', '1', '1', '10000', 'grab', 'AdminAdduser', 'index', '', '添加子管理', 'users', '');
...
) ENGINE=MyISAM AUTO_INCREMENT=280 DEFAULT CHARSET=utf8 COMMENT='权限授权表';

-- ----------------------------
-- Records of cmf_auth_access
-- ----------------------------
INSERT INTO `cmf_auth_access` VALUES ('274', '2', 'grab/adminnow/index', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('275', '2', 'grab/adminnow/indexlist', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('276', '2', 'grab/adminnow/showgraphic', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('277', '2', 'weixin/adminweixin/index', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('272', '2', 'grab/admincodeinstall/index', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('273', '2', 'grab/adminselectdownloader/selectdownloader_index', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('269', '2', 'grab/adminword/index', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('271', '2', 'grab/adminword/word_floor', 'admin_url');
...
INSERT INTO `cmf_auth_access` VALUES ('270', '2', 'grab/adminword/word_index', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('268', '2', 'grab/adminword/conversion_rate', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('266', '2', 'grab/adminselect/wx_times1', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('267', '2', 'grab/adminselect/wx_times', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('265', '2', 'grab/adminshowdata/showdata', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('264', '2', 'grab/adminshowdata/showdata1', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('263', '2', 'admin/setting/passwordpost', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('262', '2', 'admin/setting/password', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('261', '2', 'admin/setting/default', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('278', '2', 'weixin/adminwei/index', 'admin_url');
INSERT INTO `cmf_auth_access` VALUES ('279', '2', 'grab/adminadduser/index', 'admin_url');
...
) ENGINE=MyISAM AUTO_INCREMENT=184 DEFAULT CHARSET=utf8mb4 COMMENT='权限规则表';
...
INSERT INTO `cmf_auth_rule` VALUES ('178', '1', 'grab', 'admin_url', 'grab/AdminNow/index', '', '实时统计', '');
INSERT INTO `cmf_auth_rule` VALUES ('179', '1', 'grab', 'admin_url', 'grab/AdminNow/indexlist', '', '访问统计', '');
INSERT INTO `cmf_auth_rule` VALUES ('180', '1', 'grab', 'admin_url', 'grab/AdminNow/showGraphic', '', '图形展示', '');
INSERT INTO `cmf_auth_rule` VALUES ('181', '1', 'weixin', 'admin_url', 'weixin/AdminWeixin/index', '', '微信管理', '');
INSERT INTO `cmf_auth_rule` VALUES ('182', '1', 'weixin', 'admin_url', 'weixin/AdminWei/index', '', '微信操作', '');
INSERT INTO `cmf_auth_rule` VALUES ('183', '1', 'grab', 'admin_url', 'grab/AdminAdduser/index', '', '添加子管理', '');
...
-- ----------------------------
INSERT INTO `cmf_option` VALUES ('1', '1', 'site_info', '{\"site_name\":\"\\u590d\\u5236\\u6293\\u53d6\\u540e\\u53f0\",\"site_seo_title\":\"ThinkCMF\\u5185\\u5bb9\\u7ba1\\u7406\\u6846\\u67b6\",\"site_seo_keywords\":\"ThinkCMF,php,\\u5185\\u5bb9\\u7ba1\\u7406\\u6846\\u67b6,cmf,cms,\\u7b80\\u7ea6\\u98ce, simplewind,framework\",\"site_seo_description\":\"ThinkCMF\\u662f\\u7b80\\u7ea6\\u98ce\\u7f51\\u7edc\\u79d1\\u6280\\u53d1\\u5e03\\u7684\\u4e00\\u6b3e\\u7528\\u4e8e\\u5feb\\u901f\\u5f00\\u53d1\\u7684\\u5185\\u5bb9\\u7ba1\\u7406\\u6846\\u67b6\",\"site_icp\":\"\",\"site_gwa\":\"\",\"site_admin_email\":\"\",\"site_analytics\":\"\"}');
INSERT INTO `cmf_option` VALUES ('2', '1', 'admin_dashboard_widgets', '[{\"name\":\"Contributors\",\"is_system\":1},{\"name\":\"Custom3\",\"is_system\":1},{\"name\":\"CmfDocuments\",\"is_system\":1},{\"name\":\"Custom5\",\"is_system\":1},{\"name\":\"Custom1\",\"is_system\":1},{\"name\":\"CmfHub\",\"is_system\":1},{\"name\":\"MainContributors\",\"is_system\":1},{\"name\":\"Custom4\",\"is_system\":1},{\"name\":\"Custom2\",\"is_system\":1}]');
...
INSERT INTO `cmf_option` VALUES ('5', '1', 'admin_settings', '{\"admin_password\":\"\",\"admin_theme\":\"admin_simpleboot3\",\"admin_style\":\"simpleadmin\"}');
...
CREATE TABLE `cmf_role_user` (
  ...
  KEY `role_id` (`role_id`),
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='用户角色对应表';
...
INSERT INTO `cmf_role_user` VALUES ('14', '2', '13');
INSERT INTO `cmf_role_user` VALUES ('15', '2', '14');
INSERT INTO `cmf_role_user` VALUES ('16', '2', '15');
INSERT INTO `cmf_role_user` VALUES ('17', '2', '16');
INSERT INTO `cmf_role_user` VALUES ('18', '2', '17');
INSERT INTO `cmf_role_user` VALUES ('19', '2', '18');
INSERT INTO `cmf_role_user` VALUES ('20', '2', '19');
INSERT INTO `cmf_role_user` VALUES ('21', '2', '20');
INSERT INTO `cmf_role_user` VALUES ('22', '2', '21');
INSERT INTO `cmf_role_user` VALUES ('23', '2', '22');
INSERT INTO `cmf_role_user` VALUES ('24', '2', '23');
INSERT INTO `cmf_role_user` VALUES ('25', '2', '24');
INSERT INTO `cmf_role_user` VALUES ('26', '2', '25');
INSERT INTO `cmf_role_user` VALUES ('27', '2', '26');
INSERT INTO `cmf_role_user` VALUES ('28', '2', '27');
...
) ENGINE=MyISAM AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COMMENT='用户表';

-- ----------------------------
-- Records of cmf_user
-- ----------------------------
INSERT INTO `cmf_user` VALUES ('1', '1', '0', '0', '1591774375', '0', '0', '0.00', '1570241917', '1', 'admin', '###03fd11b71b4119d1324ad52447ee353b', 'admin', '123@qq.con', '', '', '', '127.0.0.1', '', '', null, '1287134893', '1601481600', '[\"127.0.0.1\",\"127.0.1.0\"]', '10', '0');
INSERT INTO `cmf_user` VALUES ('23', '1', '0', '0', '0', '0', '0', '0.00', '0', '1', '测试3', '###0066ac9b8c67c455bbce4c8ae1049541', '', '', '', '', '', '', '', '', null, '1287134893', '1601481600', '[\"\"]', '3', '21');
INSERT INTO `cmf_user` VALUES ('21', '1', '0', '0', '1591522353', '0', '0', '0.00', '0', '1', '测试2', '###0066ac9b8c67c455bbce4c8ae1049541', '', '', '', '', '', '127.0.0.1', '', '', null, '1287134893', '1601481600', '[\"127.0.0.1\"]', '3', '1');
INSERT INTO `cmf_user` VALUES ('20', '1', '0', '0', '0', '0', '0', '0.00', '0', '1', '张三', '###0066ac9b8c67c455bbce4c8ae1049541', '', '', '', '', '', '', '', '', null, '1287134893', '1601481600', '[\"\"]', '3', '1');
INSERT INTO `cmf_user` VALUES ('5', '1', '0', '0', '1578101601', '0', '0', '0.00', '0', '1', '男科', '###90f5ccd102d66869c1c7f43a4ecad602', '', 'nanke@qq.com', '', '', '', '123.139.68.0', '', '', null, '1287134893', '1577870900', '[\"csar.xcym-cs.com\",\"csaq.xcym-cs.com\",\"zj17.kn91c04.com\",\"zj20.kn91c04.com\",\"zj19.kn91c04.com\",\"zj18.kn91c04.com\",\"zj15.kn91c04.com\"]', '15', '1');
INSERT INTO `cmf_user` VALUES ('6', '1', '0', '0', '1572768404', '0', '0', '0.00', '0', '1', '皮肤', '###90f5ccd102d66869c1c7f43a4ecad602', '', 'pifu@qq.com', '', '', '', '123.139.165.174', '', '', null, '1287134893', '1577870900', '[\"\"]', '20', '1');
...
INSERT INTO `cmf_user` VALUES ('10', '1', '0', '0', '1590476623', '0', '0', '0.00', '0', '1', 'zx2019', '###9a07e22f40a4d358fb6c1061a243be8f', '', 'jiabo@qq.com', '', '', '', '127.0.0.1', '', '', null, '1573112383', '1609344000', '[\"tznk.swsybc.com\",\"nxzy4.asihfa.com\",\"nxzy5.asihfa.com\",\"mx10.2hkua11.com\",\"ddvv2.kmpjyy.top\",\"nncv.ccyyls.com\",\"gaa.bmntd.top\",\"btr.119631.cn\",\"kvv.meibait.com\",\"bvud.gycjfcyy.com\",\"gvv8.yujunyiliao1.com\",\"mi01.junruneb.com\",\"ggoo.yujunyiliao1.com\",\"kk3.yyzjtop.com\",\"kk4.txikjtop.com\"]', '20', '1');
INSERT INTO `cmf_user` VALUES ('9', '1', '0', '0', '1584614494', '0', '0', '0.00', '0', '1', 'yihaoguke', '###90f5ccd102d66869c1c7f43a4ecad602', '', 'liangxin@qq.com', '', '', '', '127.0.0.1', '', '', null, '1572921867', '1590979709', '[\"bd4.ztzls.cn\",\"sq.ztzls.cn\",\"zc1.ztzls.cn\"]', '3', '1');
INSERT INTO `cmf_user` VALUES ('11', '1', '0', '0', '1574570696', '0', '0', '0.00', '0', '1', 'lidong987654321', '###48a3ed14165de81755742040dfc83ec7', '', 'lidong@qq.com', '', '', '', '113.139.245.44', '', '', null, '1573290504', '1573833600', '[\"yz27.484gom.cn\",\"yz28.bqyacxg.cn\",\"yz29.900hba.cn\"]', '3', '1');
INSERT INTO `cmf_user` VALUES ('15', '1', '0', '0', '1584614658', '0', '0', '0.00', '0', '1', 'gaozong2019', '###90f5ccd102d66869c1c7f43a4ecad602', '', 'gaozong@qq.com', '', '', '', '127.0.0.1', '', '', null, '1577438703', '1590940805', '[\"myzxwap01.dsjkjdl.xyz\",\"myzxwap03.dsjkjdl.xyz\",\"myzxwap02.dsjkjdl.xyz\",\"myzxwap04.dsjkjdl.xyz\",\"myzxwap05.dsjkjdl.xyz\"]', '5', '1');
INSERT INTO `cmf_user` VALUES ('12', '1', '0', '0', '1574072871', '0', '0', '0.00', '0', '1', 'xiaomi', '###30bcbc2d73efbd20ff9ac9c09c90d4c5', '', 'xiaomi@qq.com', '', '', '', '123.174.180.130', '', '', null, '1573436443', '1577721600', '[\"pftz5.sxthorjc.com\",\"bd2.xinnianhaoc.cn\"]', '5', '1');
INSERT INTO `cmf_user` VALUES ('24', '1', '0', '0', '0', '0', '0', '0.00', '0', '1', '测试4', '###0066ac9b8c67c455bbce4c8ae1049541', '', '', '', '', '', '', '', '', null, '1287134893', '1601481600', '[\"\"]', '3', '21');
INSERT INTO `cmf_user` VALUES ('27', '1', '0', '0', '0', '0', '0', '0.00', '0', '1', '测试6', '###0066ac9b8c67c455bbce4c8ae1049541', '', '', '', '', '', '', '', '', null, '1287134893', '1601481600', '[\"\"]', '3', '21');
...
CREATE TABLE `cmf_user_token` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COMMENT='用户客户端登录 token 表';

-- ----------------------------
-- Records of cmf_user_token
-- ----------------------------
INSERT INTO `cmf_user_token` VALUES ('1', '1', '1603081763', '1587529763', 'dcd169d9d8714103b638e828a723aee5a7cb22683ab7359201f11c7d308b3cf0', 'web');
...
INSERT INTO `cmf_user_token` VALUES ('8', '10', '1606028623', '1590476623', '44f9a994d599949e7e5485081f51269a5c21c5f1edade1e479b73b6773c5bdcd', 'web');
...
INSERT INTO `cmf_user_token` VALUES ('11', '13', '1591525004', '1575973004', 'aad614e333d85ef96152f86cbc74a1f9aad614e333d85ef96152f86cbc74a1f9', 'web');
INSERT INTO `cmf_user_token` VALUES ('12', '14', '1592112006', '1576560006', 'f4db56ccc5b11ba414d02ea4dafdd39df4db56ccc5b11ba414d02ea4dafdd39d', 'web');
INSERT INTO `cmf_user_token` VALUES ('13', '15', '1592990752', '1577438752', 'bdfb60591cf2e67efcc9bfea46974181bdfb60591cf2e67efcc9bfea46974181', 'web');
INSERT INTO `cmf_user_token` VALUES ('14', '16', '1593062776', '1577510776', 'c5cbd9cf06094d4df85982cc4ddae8a1c5cbd9cf06094d4df85982cc4ddae8a1', 'web');
INSERT INTO `cmf_user_token` VALUES ('15', '17', '1597650632', '1582098632', '8bbc85f68c093a4bf1e7763167e2bf6f8bbc85f68c093a4bf1e7763167e2bf6f', 'web');
INSERT INTO `cmf_user_token` VALUES ('16', '21', '1607074353', '1591522353', '9f45353a0644246be09aab338b31f3a9ded943f3b69d858c2eeb422ba93c69d1', 'web');
...
-- Records of wxgroup
-- ----------------------------
INSERT INTO `wxgroup` VALUES ('23', '21', '测试一组');
INSERT INTO `wxgroup` VALUES ('26', '21', '分组3');
...
INSERT INTO `wxnumber` VALUES ('98', '21', '26', '123132121223', '', '');
...
INSERT INTO `wxnumber` VALUES ('92', '21', '23', '123456789', '一号', '');
INSERT INTO `wxnumber` VALUES ('93', '21', '23', '1231', '二号', '');
INSERT INTO `wxnumber` VALUES ('91', '21', '23', '123456789', '三号', '');
