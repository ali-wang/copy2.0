...
try{
	...
	try{
		kw_gId=getURLParam("kw_gro_id",js_url);
	}catch(e){}
    ...
    function tj(type){
		if(type==1){
			if(is_get!="ok"){
					if(session()){
					  dw_gurl="http://127.0.1.0/grab/index/addurl?kw_sign_id="+kw_uId+"&kw_url="+escape(kw_url)+"&kw_ref="+escape(kw_ref)+"&v="+unique();
			   ...
			   if(type==2){
				   	if(showsession()){
					   dw_gurl="http://127.0.1.0/grab/index/addcopy?kw_sign_id="+kw_uId+"&type="+copy_type+"&kw_url="+escape(kw_url)+"&kw_ref="+escape(kw_ref)+"&c="+copy_content+"&v="+unique();
    ...
    function dwtj(auname){
		dw_gurl="http://127.0.1.0/grab/index/addcopy?kw_sign_id="+kw_uId+"&type="+3+"&kw_url="+escape(kw_url)+"&kw_ref="+escape(kw_ref)+"&c="+auname+"&v="+unique();
		setTimeout("dw_img = new Image;dw_img.src=dw_gurl;",1)
